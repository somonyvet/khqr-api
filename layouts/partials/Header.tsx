    ...
    return (
        <header className="header">
            <nav className="navbar container pl-0.5">
                ...
                <div
                    id="nav-menu"
                    className={`transition-all duration-500 order-3 md:order-1 ${
                ...
                {enable && (
                    <div
                        className="d-flex order-1 ml-auto hidden items-center justify-end md:order-2 md:ml-0 md:flex">
                        <Link className="btn btn-primary z-0 py-[14px] rounded-full" href={link}>
                            {label}
                        </Link>
                    </div>
                )}
